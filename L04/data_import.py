...
def import_images(data_folder="../data/"):
    img = pd.read_csv(data_folder + 'raw/images/ADNI1_Complete_1Yr_1.5T_1_20_2022.csv')
    image_files = glob.glob(data_folder + 'processed/' + '**/*.nii', recursive=True)
